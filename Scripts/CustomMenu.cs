...
public class CustomMenu : MonoBehaviour
{
    ...
    {
        SetRules();
        PlayerPrefs.SetString("deathRules", string.Join(" ", death));
        PlayerPrefs.SetString("birthRules", string.Join(" ", birth));
        PlayerPrefs.SetInt("maxAge", maxAge);
        UnityEngine.SceneManagement.SceneManager.LoadScene("CustomGame");
    }
}
